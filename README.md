# � EcoSync — Intelligent Carbon Footprint Tracker

> Track your environmental impact, understand where your emissions come from, and take meaningful climate action — all in your browser, completely private.

**Live demo:** (https://ecosync-carbon.vercel.app/)

EcoSync is your personal sustainability assistant. In just 2 minutes, answer simple questions about your lifestyle and instantly receive:
- **Your annual CO₂e footprint** with detailed category breakdown
- **Smart personalized recommendations** ranked by real impact
- **Progress tracking** with goal-setting capabilities
- **Regional comparisons** against averages and the 1.5°C science-based target

All calculations happen locally on your device — nothing is stored on servers, nothing about you is tracked.

## Chosen vertical

**Sustainability & Climate Intelligence.** Most people want to lower their environmental impact but
don't know (a) what their footprint actually is, or (b) which changes matter most. Generic
advice ("recycle more") ignores personal context. **EcoSync** is an **intelligent personal carbon assistant**
that reasons over each person's unique situation and provides contextual, data-driven insights on where
emissions come from and what actions have the highest impact.
...
**A dynamic, context-aware assistant—not a static calculator.** The heart of **EcoSync** is an intelligent,
deterministic recommendation engine (`src/lib/tips-engine.ts`) that makes logical decisions from user
...
emission factors as the calculator, ensuring internal consistency and impact-ranked prioritization.
